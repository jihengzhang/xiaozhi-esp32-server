...
// Check if Opus library has been loaded
export function checkOpusLoaded() {
    try {
        ...
        // Try to use Module.instance first (libopus.js export method at last line)
        ...
        opusEncoder = {
            ...
            init: function () {
                try {
                    ...
                    // Set to use DTX (no transmission of silence frames)
